...
== Upgrade Notice ==
= 8.0.0 =
Major update. CTX Feed 8.0 introduces a rewritten feed engine and a new admin interface. Your existing feeds and settings are carried over automatically (no reconfiguration), but this is a big release — please BACK UP your site and database before updating, and check your feeds afterwards. Requires PHP 7.4 or higher (sites on older PHP stay on 6.6.23). If anything looks off right after updating, deactivate and reactivate the plugin. Found any issue? Contact our support team at support@webappick.com.
